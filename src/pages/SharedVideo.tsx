...
import { Download, Play, Pause, ChevronLeft, ChevronRight, Film, Monitor, Smartphone, Square } from "lucide-react";
          ...
          <div className="flex items-center justify-center gap-1.5">
            {scenes.map((_, i) => (
              <button
                ...
                className={`w-2.5 h-2.5 rounded-full transition-all ${i === activeScene ? "bg-primary w-5" : "bg-muted-foreground/30"}`}
              />
            ))}
          </div>
        </div>
