...
const CampaignManager = () => {
  ...
  if (activeCampaign) {
    return <CampaignDetailView campaign={activeCampaign} onBack={() => { setActiveCampaign(null); loadCampaigns(); }} onUpdateStatus={updateStatus} copyShareLink={copyShareLink} getShareUrl={getShareUrl} />;
  }
